...
RGWUser::RGWUser() : endpoints(this), caps(this), keys(this), subusers(this)
{
  init_default();
}
...
int RGWUserAdminOp_Endpoint::create(rgw::sal::RGWRadosStore *store, RGWUserAdminOpState& op_state,
                  RGWFormatterFlusher& flusher)
{
  RGWUserInfo info;
  RGWUser user;
...
int RGWUserAdminOp_Endpoint::modify(rgw::sal::RGWRadosStore *store, RGWUserAdminOpState& op_state,
                  RGWFormatterFlusher& flusher)
{
  RGWUserInfo info;
  RGWUser user;
...
int RGWUserAdminOp_Endpoint::remove(rgw::sal::RGWRadosStore *store, RGWUserAdminOpState& op_state,
                  RGWFormatterFlusher& flusher)
{
  RGWUserInfo info;
  RGWUser user;
