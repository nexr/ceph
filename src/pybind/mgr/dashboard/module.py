...
class CherryPyConfig(object):
    ...
    def cors_tool(self):
        ...
        req_header_origin_url = req_head.get('Origin') if req_head.get('Origin') \
                           else req_head.get('Access-Control-Allow-Origin')
        ...
        if (req_header_origin_url) and \
           ('*' in cross_origin_url_list or req_header_origin_url in cross_origin_url_list):
